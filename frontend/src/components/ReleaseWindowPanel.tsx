  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
        ...
        <span style={{ fontSize: '0.72rem', color: '#10b981', backgroundColor: '#10b98115', border: '1px solid #10b98140', padding: '0.15rem 0.5rem', borderRadius: '4px' }}>
      ...
      {releaseWindow ? (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.5rem', fontSize: '0.8rem' }}>
          <div style={{ backgroundColor: '#1e293b', padding: '0.5rem 0.6rem', borderRadius: '6px' }}>
          ...
          <div style={{ backgroundColor: '#1e293b', padding: '0.5rem 0.6rem', borderRadius: '6px', border: '1px solid #f59e0b40' }}>
